...
echo -e "\e[32m *** Be notified that you are building for beryllium  ***"
...
# Generate the default configuration for Xiaomi POCO F1 (beryllium)
echo -e "\e[34m *** Stage 3 - Generating default configuration for beryllium... ***"
echo -e "\e[0m "
cat arch/arm64/configs/vendor/xiaomi/beryllium.config \
    arch/arm64/configs/vendor/xiaomi/mi845_defconfig \
    > arch/arm64/configs/beryllium_defconfig    # Merge configuration for beryllium
