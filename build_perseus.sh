...
echo -e "\e[32m *** Be notified that you are building for perseus  ***"
...
# Generate the default configuration for Xiaomi Mi MIX 3 (perseus)
echo -e "\e[34m *** Stage 3 - Generating default configuration for perseus... ***"
echo -e "\e[0m "
cat arch/arm64/configs/vendor/xiaomi/perseus.config \
    arch/arm64/configs/vendor/xiaomi/mi845_defconfig \
    > arch/arm64/configs/perseus_defconfig    # Merge configuration for perseus
make O=out perseus_defconfig
