...
echo -e "\e[32m *** Be notified that you are building for polaris  ***"
...
# Generate the default configuration for Xiaomi Mi MIX 2S (polaris)
echo -e "\e[34m *** Stage 3 - Generating default configuration for polaris... ***"
echo -e "\e[0m "
cat arch/arm64/configs/vendor/xiaomi/polaris.config \
    arch/arm64/configs/vendor/xiaomi/mi845_defconfig \
    > arch/arm64/configs/polaris_defconfig    # Merge configuration for polaris
